...
модального вікна. Він знаходиться в файлі index.html після футера.
...
«C7» У всіх інпутів є свій пов'язаний елемент <label>.
...
«C11» Тег <textarea> має бути з фіксованим розміром, користувач не повинен мати
можливості змінювати його.
